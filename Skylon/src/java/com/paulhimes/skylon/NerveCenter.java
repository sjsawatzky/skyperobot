...
public class NerveCenter {
	...
	public NerveCenter() {
		...
		// Add the actions.
		// chatListener.add(new SimpleChatAction() {
		...
		try {
			Class[] classes = getClasses("com.paulhimes.skyperobot.chatactions");

			for (Class clazz : classes) {
				try {
					ChatAction action = (ChatAction) Class.forName(clazz.getName()).newInstance();
